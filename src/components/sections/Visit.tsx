      ...
      >
        <div className="grid grid-cols-1 gap-10 p-10 sm:p-14 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <h2 className="font-display text-4xl sm:text-5xl">COME SAY HELLO</h2>
            ...
            <address className="mt-8 grid gap-2 not-italic text-cream/90">
              <span className="text-lg font-semibold">FOUR - Fairways, Sector M, DHA Phase 6, Lahore</span>
              <span className="text-cream/70">Open daily · 12:00 pm to 2:00 am</span>
              <a href="tel:+924211111111" className="w-fit font-semibold text-cream underline-offset-4 transition hover:underline">
                Call the restaurant
              </a>
            </address>
          </div>
