...
export const MENU_ITEMS: MenuItemData[] = [
  // ── Beef Smash Burgers (110g) ─────────────────────────────
  {
    ...
    description: "Two 110g patties smashed to lace-edged crisp, American cheese, onion, pickles, FOUR sauce.",
    price: 999,
  ...
  },
  {
    ...
    name: "London BBQ",
    category: "smash-burgers",
    description: "Smashed beef under a smoky BBQ glaze, sharp cheddar and a tangle of crispy onions.",
    price: 949,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  },
  {
    ...
    category: "smash-burgers",
    description: "Smashed beef in a flamin hot crust with jalapeños and chipotle mayo. Not subtle.",
    price: 949,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  },
  {
    ...
    name: "Paris Truffle",
    category: "smash-burgers",
    description: "Smashed beef, truffle mayo, swiss cheese and slow caramelised onion.",
    price: 949,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  // ── Chicken Burgers ───────────────────────────────────────
  {
    ...
    description: "Crispy fried chicken in Bangkok chilli glaze, chipotle spice, slaw and lime mayo.",
    price: 849,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  },
  {
    ...
    category: "chicken-burgers",
    description: "Crispy fillet, sweet honey mustard, crisp lettuce and pickles.",
    price: 849,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  },
  {
    ...
    name: "Cheesy Mexico",
    category: "chicken-burgers",
    description: "Crispy fillet buried under molten cheese sauce and jalapeños.",
    price: 949,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  },
  {
    ...
    name: "Vegas Parm",
    category: "chicken-burgers",
    description: "Crispy fillet with parmesan cream, marinara and a toasted crumb finish.",
    price: 849,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  },
  {
    ...
    name: "Cairo Chipotle",
    category: "chicken-burgers",
    description: "Crispy fillet, smoky chipotle mayo and cold, crunchy slaw.",
    price: 849,
    modifierGroups: ["meal-deal", "add-ons"],
  ...
  // ── Wings (6 pcs) ─────────────────────────────────────────
  {
    ...
    name: "Plain Wings",
    category: "wings",
    description: "Six wings fried crisp, seasoned simply, dip on the side.",
    price: 399,
  ...
  },
  {
    ...
    name: "Masala Wings",
    category: "wings",
    description: "Six wings dusted in desi masala while they are still hot.",
    price: 449,
  ...
  },
  {
    ...
    name: "BBQ Wings",
    category: "wings",
    description: "Six wings tossed in smoky BBQ until they turn sticky.",
    price: 549,
  ...
  },
  {
    ...
    name: "Cheese Wings",
    category: "wings",
    description: "Six wings under molten cheese sauce. Take the napkins.",
    price: 549,
  ...
  // ── Fries ─────────────────────────────────────────────────
  {
    ...
    name: "Plain Fries",
    category: "fries",
    description: "Golden, crisp, properly salted.",
    price: 349,
  ...
  },
  {
    ...
    name: "Masala Fries",
    category: "fries",
    description: "Crisp fries with a desi masala hit.",
    price: 349,
  ...
  },
  {
    ...
    name: "New York Fries",
    category: "fries",
    description: "Buried in cheese sauce, smashed beef crumble and FOUR sauce.",
    price: 799,
  ...
  },
  {
    ...
    name: "Bangkok Fries",
    category: "fries",
    description: "Loaded with crispy chicken and Bangkok chilli glaze.",
    price: 799,
  ...
  },
  {
    ...
    name: "Disco Fries",
    category: "fries",
    description: "Cheese sauce, gravy, and all the crispy bits at the bottom.",
    price: 799,
    aliases: ["disco fries"],
  },
  {
    ...
    name: "Lahori Fries",
    category: "fries",
    description: "Loaded the Lahori way: chatpata, saucy, unapologetic.",
    price: 799,
  ...
  },
  {
    ...
    name: "Tandoori Tikka",
    category: "pizzas",
    description: "Charred tandoori tikka over red sauce and mozzarella.",
    price: 599,
  ...
  },
  {
    ...
    category: "pizzas",
    description: "Creamy base, malai boti, and a crown crust stuffed with cheese.",
    price: 1349,
  ...
  },
  {
    ...
    category: "pizzas",
    description: "Red sauce base, malai boti, and a crown crust stuffed with cheese.",
    price: 1349,
    variants: PIZZA_SIZES(null, 1349, 1749),
    modifierGroups: ["pizza-toppings"],
  ...
  },
  {
    ...
    name: "BBQ Peperoni",
    category: "pizzas",
    description: "Smoky BBQ base, beef peperoni and mozzarella.",
    price: 599,
    variants: PIZZA_SIZES(599, 1299, 1699),
    modifierGroups: ["pizza-toppings"],
  ...
  },
  {
    ...
    name: "Cheesy Cheese",
    category: "pizzas",
    description: "For purists: mozzarella, cheddar, nothing else.",
    price: 599,
    variants: PIZZA_SIZES(599, 1299, 1699),
    modifierGroups: ["pizza-toppings"],
  ...
  },
  {
    ...
    category: "pizzas",
    description: "Smoky chipotle chicken, peppers and a chipotle ranch drizzle.",
    price: 599,
    variants: PIZZA_SIZES(599, 1299, 1699),
    modifierGroups: ["pizza-toppings"],
  ...
  },
  {
    ...
    category: "pizzas",
    description: "Our crust ringed with seekh kebab, spiced beef over the top.",
    price: 1299,
    variants: PIZZA_SIZES(null, 1299, 1699),
    modifierGroups: ["pizza-toppings"],
  ...
  // ── Calzones & Sides ──────────────────────────────────────
  {
    ...
    category: "calzones",
    description: "Malai boti and cheese folded in, baked until golden.",
    price: 1050,
  ...
  // ── Drinks ────────────────────────────────────────────────
  { id: "cola", name: "Cola", category: "drinks", description: "Ice-cold cola.", price: 179, aliases: ["cola", "coke", "coca cola", "pepsi", "soda", "soft drink"] },
  { id: "white-soda", name: "White Soda", category: "drinks", description: "Clear, crisp and ice-cold.", price: 179, aliases: ["white soda", "sprite", "7up", "seven up"] },
  { id: "cola-zero", name: "Cola Zero", category: "drinks", description: "All the taste, none of the sugar.", price: 179, aliases: ["cola zero", "coke zero", "zero cola", "diet coke"] },
  { id: "white-soda-zero", name: "White Soda Zero", category: "drinks", description: "Clear, crisp, zero sugar.", price: 179, aliases: ["white soda zero", "sprite zero", "7up free"] },
  { id: "orange-soda", name: "Orange Soda", category: "drinks", description: "Sweet, fizzy and ice-cold.", price: 179, aliases: ["orange soda", "fanta", "mirinda"] },
  { id: "mint-margarita", name: "Mint Margarita", category: "drinks", description: "Fresh mint and lime, blended cold.", price: 449, aliases: ["mint margarita", "mint margrita", "margarita"] },
  { id: "fresh-lemonade", name: "Fresh Lemonade", category: "drinks", description: "Squeezed to order. Sharp and cold.", price: 229, aliases: ["fresh lemonade", "lemonade", "lemon"] },
  { id: "iced-milo", name: "Iced Milo", category: "drinks", description: "The viral one. Thick, chocolatey, over ice.", price: 499, aliases: ["iced milo", "milo"] },

  // ── Fizz Chillers ─────────────────────────────────────────
  { id: "peach-fizz", name: "Peach Fizz", category: "fizz-chillers", description: "Frozen peach, fizzing all the way down.", price: 449, aliases: ["peach fizz", "peach"] },
  { id: "passion-fizz", name: "Passion Fizz", category: "fizz-chillers", description: "Passion fruit blended to slush. Sharp and sweet.", price: 449, aliases: ["passion fizz", "passion fruit"] },
  { id: "mango-fizz", name: "Mango Fizz", category: "fizz-chillers", description: "Frozen mango. Summer in a cup.", price: 449, aliases: ["mango fizz", "mango"] },
  { id: "lychee-fizz", name: "Lychee Fizz", category: "fizz-chillers", description: "Lychee, floral and frozen.", price: 449, aliases: ["lychee fizz", "lychee"] },
  { id: "raspberry-lemonade-frozen", name: "Raspberry Lemonade Frozen", category: "fizz-chillers", description: "Raspberry lemonade, blended to a frozen slush.", price: 449, aliases: ["raspberry lemonade", "raspberry fizz", "frozen lemonade"] },

  // ── Shakes ────────────────────────────────────────────────
  { id: "lotus-shake", name: "Lotus Shake", category: "shakes", description: "Lotus Biscoff blended thick, crumble on top.", price: 699, aliases: ["lotus shake", "biscoff shake", "lotus"], tags: ["bestseller"] },
  { id: "matilda-shake", name: "Matilda Shake", category: "shakes", description: "Chocolate cake in a cup, Matilda style.", price: 699, aliases: ["matilda shake", "matilda", "chocolate cake shake"] },
  ...
  { id: "snickers-shake", name: "Snickers Shake", category: "shakes", description: "Snickers, peanuts and chocolate, blended thick.", price: 649, aliases: ["snickers shake", "snickers"] },
  { id: "strawberry-banana-shake", name: "Strawberry Banana Shake", category: "shakes", description: "Fresh strawberry and banana, blended smooth.", price: 649, aliases: ["strawberry banana shake", "strawberry shake", "banana shake"] },
  ...
  // ── Desserts ──────────────────────────────────────────────
  {
    ...
    category: "desserts",
    description: "Cream cheese layered with lotus ganache, cookie crumble on top.",
    price: 449,
  ...
  },
  {
    ...
    category: "desserts",
    description: "Cream cheese on a cookie base with chocolate ganache and Alaska brownie.",
    price: 449,
  ...
  },
  {
    ...
    category: "desserts",
    description: "Cream cheese layered with berry puree and cookie crumble.",
    price: 499,
  ...
  },
  {
    ...
    category: "desserts",
    description: "Warm lava cookie under ice cream, lotus ganache poured over.",
    price: 599,
